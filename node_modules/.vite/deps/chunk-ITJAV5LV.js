...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react3.useMemo)(function() {
...
var OffcanvasToggling = React4.forwardRef(({
  bsPrefix,
  className,
  children,
  ...props
...
var Offcanvas = React5.forwardRef(({
  ...
  const modalManager = (0, import_react4.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react4.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react4.useState)(false);
  ...
  const renderBackdrop = (0, import_react4.useCallback)((backdropProps) => (0, import_jsx_runtime5.jsx)("div", {
    ...backdropProps,
...
Offcanvas.defaultProps = defaultProps4;
...
var NavbarCollapse = React6.forwardRef(({
  ...
  return (0, import_jsx_runtime8.jsx)(Collapse_default, {
...
var NavbarToggle = React7.forwardRef(({
  ...
  return (0, import_jsx_runtime9.jsx)(Component, {
    ...
    onClick: handleClick,
    "aria-label": label,
    className: (0, import_classnames6.default)(className, bsPrefix, !expanded && "collapsed"),
    children: children || (0, import_jsx_runtime9.jsx)("span", {
      className: `${bsPrefix}-icon`
    })
  });
});
NavbarToggle.displayName = "NavbarToggle";
NavbarToggle.defaultProps = defaultProps5;
...
Navbar.defaultProps = defaultProps6;
...
//# sourceMappingURL=chunk-ITJAV5LV.js.map
