...
function useForceUpdate() {
  var _useReducer = (0, import_react9.useReducer)(function(state) {
    return !state;
...
var Nav = React6.forwardRef((_ref, ref) => {
  ...
  const needsRefocusRef = (0, import_react10.useRef)(false);
  const parentOnSelect = (0, import_react10.useContext)(SelectableContext_default);
  const tabContext = (0, import_react10.useContext)(TabContext_default);
  ...
  const listNode = (0, import_react10.useRef)(null);
  ...
  return (0, import_jsx_runtime4.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime4.jsx)(NavContext_default.Provider, {
      value: {
        role,
      ...
      children: (0, import_jsx_runtime4.jsx)(Component, Object.assign({}, props, {
        onKeyDown: handleKeyDown,
        ref: mergedRef,
        role
      }))
...
//# sourceMappingURL=chunk-UFI245UH.js.map
